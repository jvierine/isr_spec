...
class ilint:
    ...
    def getspec(self, ne=n.array([1e11]), te=n.array([600]), ti=n.array([300]), mol_frac=n.array([1.0])):
        ...
        print(te_ti_ratio_idx)
        print(mol_frac_idx)
        print(n.ceil(mol_frac_idx))
        print(n.floor(mol_frac_idx))        
        ...
        # assume ion-line edges dissappear to 0
